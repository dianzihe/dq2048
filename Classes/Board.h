...
namespace PH { // tolua_export
    ...
    */
    ...
    {
        function<bool(GemGrid& grid)> call;
    };
...
#define IS_FLAG_SET(val, flag) (val & flag)
    ...
    public:
        ...
        */
		...
		/*
        TaskPtr applyComboModWithAnim(const BoardResult& result, AttackTable& outTable);
        TaskPtr applySkillModWithAnim(const AttackTable& attackTable, AttackTable& outTable);
        ...
        */
        ...
        //EnemyControlList getEnemiesInAttackOrder(const GemUtils::GemColor color, const bool isArea);
        ...
        //void transitionToGameScene(bool isVictory, PlayerPtr newPlayer);
